...
abstract class TestCase extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * This method is a temporary solution to provide backward compatibility for
     * tests that are still using the old (4.8) getMock() method.
     * We should update the code and remove this method but for now this is good
     * enough.
     *
     *
